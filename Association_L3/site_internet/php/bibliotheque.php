...
function html_aside_main_debut(){
	echo '<div class="container-fluid">',
    		'<div class="col-sm-3 col-md-2 sidebar">',
      		...
      		'</ul>',
      		'<ul class="nav nav-sidebar">',
        		'<li><a href="formation.php"><span class="fa fa-book" aria-hidden="true"></span>Formations</a></li>',
        		'<li><a href="./testStageAdmin.html"><span class="fa fa-briefcase" aria-hidden="true"></span>Stages</a></li>',
      		'</ul>',
      		'<ul class="nav nav-sidebar">',
        		'<li class="active"><a href="listeEntreprise.php"><span class="fa fa-industry" aria-hidden="true"></span>Entreprises</a></li>',
      		...
      		'<ul class="nav nav-sidebar">',
		        ...
		        '<li><a href="gestionCompte.php"><span class="fa fa-user" aria-hidden="true"></span>Paramètre compte</a></li>',
