  ...
  echo '<h1 class="page-header">Nos membres</h1>',
        '<div class="col-md-12">',
          '<form class="form_inline" method="POST" action="listeMembre.php" accept-charset="iso-8859-1">',
            '<div class="col-md-4">',
              '<button class="btn btn-inline btn-success btn-block" name="typeMembre" onclick="javascript:openGestion([\'gestionStatistiques\', \'gestionStages\']); return false;" value="1"><span class="text-danger fa fa-times" aria-hidden="true"></span>Entreprises</button>',
            '</div>',
            '<div class="col-md-4">',
              '<button class="btn btn-inline btn-success btn-block" name="typeMembre" onclick="javascript:openGestion([\'gestionStatistiques\', \'gestionStages\']); return false;" value="2"><span class="text-danger fa fa-times" aria-hidden="true"></span>Etudiants</button>',
            '</div>',
            '<div class="col-md-4">',
              '<button class="btn btn-inline btn-success btn-block" name="typeMembre" onclick="javascript:openGestion([\'gestionStatistiques\', \'gestionStages\']); return false;" value="3"><span class="text-danger fa fa-times" aria-hidden="true"></span>Bénévoles</button>',
            '</div>',
          '</form>',
        '</div>';
