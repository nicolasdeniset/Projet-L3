    ...
    echo '<div class="row">',
          '<form method="POST" action="gestionCompte.php" accept-charset="iso-8859-1">',
            ...
            '<div class="col-md-12">',
              ...
              '</div>',
              '<div class="col-md-4">',
                '<button type="reset" class="btn btn-inline btn-info btn-block" name="btnValider2">Annuler changements</button>',
              '</div>',
              '<div class="col-md-4">',
                '<button type="submit" value="enregistrer" class="btn btn-inline btn-success btn-block" name="btnValider"><span class="fa fa-check" aria-hidden="true"></span>Sauvegarder changements</button>',
              '</div>',
            '</div>',
          '</form>',
        '</div>';
